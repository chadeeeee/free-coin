...
export default function JoinPage() {
    ...
    return (
        <div className="relative min-h-screen w-full overflow-hidden flex items-center justify-center">
            ...
            {/* Join Form */}
            <div className="relative z-10 w-full max-w-md mx-4 my-20">
                <div
                ...
                >
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-[#f5e6c8]/60 text-sm">Join and start spinning</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className=" px-4 py-4 rounded-lg text-[#f5e6c8] placeholder-[#f5e6c8]/30 border border-[#c9a84c]/20 focus:border-[#c9a84c]/60 focus:outline-none transition-all duration-300 focus:shadow-[0_0_20px_rgba(201,168,76,0.15)]"
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-4 rounded-lg text-[#1a1208] font-bold uppercase tracking-[0.2em] text-sm bg-gradient-to-r from-[#f5d77a] to-[#c9a84c] hover:from-[#ffe599] hover:to-[#d4b35a] transition-all duration-300 cursor-pointer shadow-[0_0_25px_rgba(201,168,76,0.3)] hover:shadow-[0_0_35px_rgba(201,168,76,0.5)] disabled:opacity-60 disabled:cursor-not-allowed mt-4"
